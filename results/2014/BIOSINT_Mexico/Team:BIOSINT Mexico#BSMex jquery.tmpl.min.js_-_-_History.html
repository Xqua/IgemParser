...
<link title="Creative Commons" type="application/rdf+xml" href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;action=creativecommons" rel="meta" />
<link rel="copyright" href="http://creativecommons.org/licenses/by/3.0/" />
<link rel="alternate" type="application/atom+xml" title="&quot;Team:BIOSINT Mexico/BSMex jquery.tmpl.min.js&quot; Atom feed" href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;feed=atom&amp;action=history" />
<link rel="alternate" type="application/atom+xml" title="2014.igem.org Atom feed" href="/wiki/index.php?title=Special:RecentChanges&amp;feed=atom" />		<title>Revision history of &quot;Team:BIOSINT Mexico/BSMex jquery.tmpl.min.js&quot; - 2014.igem.org</title>
...
wgNamespaceNumber=0,
wgPageName="Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js",
wgTitle="Team:BIOSINT Mexico/BSMex jquery.tmpl.min.js",
wgAction="history",
wgArticleId=36893,
wgIsArticle=false,
wgUserName=null,
...
<body              class="mediawiki  ltr ns-0 ns-subject page-Team_BIOSINT_Mexico_BSMex_jquery_tmpl_min_js">
  <div id="globalWrapper">
	...
	<script type="text/javascript"> if (window.isMSIE55) fixalpha(); </script>
 	...
 	<div id="menubar" class='left-menu noprint'>
 	  <ul>
 	                   <li 
                class='selected' 	       ><a href="/Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js">Page               </a></li>
               <li 
                class='new' 	       ><a href="/wiki/index.php?title=Talk:Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;action=edit&amp;redlink=1">Discussion               </a></li>
               <li 
               	       ><a href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;action=edit">View source               </a></li>
               <li 
                class='selected' 	       ><a href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;action=history">History               </a></li>
	...
	<div class="right-menu noprint" id="menubar">
	    <ul>
                				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li> 	    </ul>
    ...
    <div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Revision history of &quot;Team:BIOSINT Mexico/BSMex jquery.tmpl.min.js&quot;</h1>
		<div id="bodyContent">
			<h3 id="siteSub" class='noprint'>From 2014.igem.org</h3>
			<div id="contentSub"><a href="/wiki/index.php?title=Special:Log&amp;page=Team%3ABIOSINT+Mexico%2FBSMex+jquery.tmpl.min.js" title="Special:Log">View logs for this page</a></div>
						<!--
			<div id="jump-to-nav">Jump to:                        <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>-->
			<!-- start content -->
			<form action="/wiki/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;oldid=265227" title="Team:BIOSINT Mexico/BSMex jquery.tmpl.min.js">06:43, 16 October 2014</a> <span class='history-user'><a href="/wiki/index.php?title=User:Cehc1193&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Cehc1193 (page does not exist)">Cehc1193</a>  <span class="mw-usertoollinks">(<a href="/wiki/index.php?title=User_talk:Cehc1193&amp;action=edit&amp;redlink=1" class="new" title="User talk:Cehc1193 (page does not exist)">Talk</a> | <a href="/Special:Contributions/Cehc1193" title="Special:Contributions/Cehc1193">contribs</a>)</span></span> <span class="history-size">(6,007 bytes)</span> <span class="comment">(Created page with &quot;(function(a){var r=a.fn.domManip,d=&quot;_tmplitem&quot;,q=/^[^&lt;]*(&lt;[\w\W]+&gt;)[^&gt;]*$|\{\{\! /,b={},f={},e,p={key:0,data:{}},h=0,c=0,l=[];function g(e,d,g,i){var c={data:i||(d?d.data:{}),_wr...&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://2014.igem.org/Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js">http://2014.igem.org/Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js</a>"</div>
...
<div class="visualClear"></div>
    <div id='footer-box' class='noprint'>
	   ...
	   <!-- Recentchanges is not handles well DEBUG -->
		     ...
		     <li id="t-whatlinkshere"><a href="/Special:WhatLinksHere/Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js"
		      title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>

                         <li id="t-recentchangeslinked"><a href="/Special:RecentChangesLinked/Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js"
                          title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>


	             <li id="feedlinks">
		             <span id="feed-atom">
		             <a href="/wiki/index.php?title=Team:BIOSINT_Mexico/BSMex_jquery.tmpl.min.js&amp;feed=atom&amp;action=history"
