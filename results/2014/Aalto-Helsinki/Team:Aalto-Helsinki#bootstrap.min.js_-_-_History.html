...
<link title="Creative Commons" type="application/rdf+xml" href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;action=creativecommons" rel="meta" />
<link rel="copyright" href="http://creativecommons.org/licenses/by/3.0/" />
<link rel="alternate" type="application/atom+xml" title="&quot;Team:Aalto-Helsinki/bootstrap.min.js&quot; Atom feed" href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;feed=atom&amp;action=history" />
<link rel="alternate" type="application/atom+xml" title="2014.igem.org Atom feed" href="/wiki/index.php?title=Special:RecentChanges&amp;feed=atom" />		<title>Revision history of &quot;Team:Aalto-Helsinki/bootstrap.min.js&quot; - 2014.igem.org</title>
...
wgNamespaceNumber=0,
wgPageName="Team:Aalto-Helsinki/bootstrap.min.js",
wgTitle="Team:Aalto-Helsinki/bootstrap.min.js",
wgAction="history",
wgArticleId=11091,
wgIsArticle=false,
wgUserName=null,
...
<body              class="mediawiki  ltr ns-0 ns-subject page-Team_Aalto-Helsinki_bootstrap_min_js">
  <div id="globalWrapper">
	...
	<script type="text/javascript"> if (window.isMSIE55) fixalpha(); </script>
 	...
 	<div id="menubar" class='left-menu noprint'>
 	  <ul>
 	                   <li 
                class='selected' 	       ><a href="/Team:Aalto-Helsinki/bootstrap.min.js">Page               </a></li>
               <li 
                class='new' 	       ><a href="/wiki/index.php?title=Talk:Team:Aalto-Helsinki/bootstrap.min.js&amp;action=edit&amp;redlink=1">Discussion               </a></li>
               <li 
               	       ><a href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;action=edit">View source               </a></li>
               <li 
                class='selected' 	       ><a href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;action=history">History               </a></li>
	...
	<div class="right-menu noprint" id="menubar">
	    <ul>
                				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Team:Aalto-Helsinki/bootstrap.min.js&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li> 	    </ul>
    ...
    <div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Revision history of &quot;Team:Aalto-Helsinki/bootstrap.min.js&quot;</h1>
		<div id="bodyContent">
			<h3 id="siteSub" class='noprint'>From 2014.igem.org</h3>
			<div id="contentSub"><a href="/wiki/index.php?title=Special:Log&amp;page=Team%3AAalto-Helsinki%2Fbootstrap.min.js" title="Special:Log">View logs for this page</a></div>
						<!--
			<div id="jump-to-nav">Jump to:                        <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>-->
			<!-- start content -->
			<form action="/wiki/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Team:Aalto-Helsinki/bootstrap.min.js" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;oldid=91798" title="Team:Aalto-Helsinki/bootstrap.min.js">07:45, 28 August 2014</a> <span class='history-user'><a href="/wiki/index.php?title=User:Vaakapallo&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Vaakapallo (page does not exist)">Vaakapallo</a>  <span class="mw-usertoollinks">(<a href="/wiki/index.php?title=User_talk:Vaakapallo&amp;action=edit&amp;redlink=1" class="new" title="User talk:Vaakapallo (page does not exist)">Talk</a> | <a href="/Special:Contributions/Vaakapallo" title="Special:Contributions/Vaakapallo">contribs</a>)</span></span> <span class="history-size">(31,819 bytes)</span> <span class="comment">(Created page with &quot;<span class="autocomment">- <a href="/Team:Aalto-Helsinki/bootstrap.min.js#.21_.2A_Bootstrap_v3.2.0_.28http:.2F.2Fgetbootstrap.com.29_.2A_Copyright_2011-2014_Twitter.2C_Inc._.2A_Licensed_under_MIT_.28https:.2F.2Fgithub.com.2Ftwbs.2Fbootstrap.2Fblob.2Fmaster.2FLICENSE.29" title="Team:Aalto-Helsinki/bootstrap.min.js">→</a>!  * Bootstrap v3.2.0 (http://getbootstrap.com)  * Copyright 2011-2014 Twitter, Inc.  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE): </span> if(&quot;undef...&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://2014.igem.org/Team:Aalto-Helsinki/bootstrap.min.js">http://2014.igem.org/Team:Aalto-Helsinki/bootstrap.min.js</a>"</div>
...
<div class="visualClear"></div>
    <div id='footer-box' class='noprint'>
	   ...
	   <!-- Recentchanges is not handles well DEBUG -->
		     ...
		     <li id="t-whatlinkshere"><a href="/Special:WhatLinksHere/Team:Aalto-Helsinki/bootstrap.min.js"
		      title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>

                         <li id="t-recentchangeslinked"><a href="/Special:RecentChangesLinked/Team:Aalto-Helsinki/bootstrap.min.js"
                          title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>


	             <li id="feedlinks">
		             <span id="feed-atom">
		             <a href="/wiki/index.php?title=Team:Aalto-Helsinki/bootstrap.min.js&amp;feed=atom&amp;action=history"
