...
<link title="Creative Commons" type="application/rdf+xml" href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;action=creativecommons" rel="meta" />
<link rel="copyright" href="http://creativecommons.org/licenses/by/3.0/" />
<link rel="alternate" type="application/atom+xml" title="&quot;Team:CAU China/jquery.plugin.min.js&quot; Atom feed" href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;feed=atom&amp;action=history" />
<link rel="alternate" type="application/atom+xml" title="2014.igem.org Atom feed" href="/wiki/index.php?title=Special:RecentChanges&amp;feed=atom" />		<title>Revision history of &quot;Team:CAU China/jquery.plugin.min.js&quot; - 2014.igem.org</title>
...
wgNamespaceNumber=0,
wgPageName="Team:CAU_China/jquery.plugin.min.js",
wgTitle="Team:CAU China/jquery.plugin.min.js",
wgAction="history",
wgArticleId=36444,
wgIsArticle=false,
wgUserName=null,
...
<body              class="mediawiki  ltr ns-0 ns-subject page-Team_CAU_China_jquery_plugin_min_js">
  <div id="globalWrapper">
	...
	<script type="text/javascript"> if (window.isMSIE55) fixalpha(); </script>
 	...
 	<div id="menubar" class='left-menu noprint'>
 	  <ul>
 	                   <li 
                class='selected' 	       ><a href="/Team:CAU_China/jquery.plugin.min.js">Page               </a></li>
               <li 
                class='new' 	       ><a href="/wiki/index.php?title=Talk:Team:CAU_China/jquery.plugin.min.js&amp;action=edit&amp;redlink=1">Discussion               </a></li>
               <li 
               	       ><a href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;action=edit">View source               </a></li>
               <li 
                class='selected' 	       ><a href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;action=history">History               </a></li>
	...
	<div class="right-menu noprint" id="menubar">
	    <ul>
                				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Team:CAU_China/jquery.plugin.min.js&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li> 	    </ul>
    ...
    <div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Revision history of &quot;Team:CAU China/jquery.plugin.min.js&quot;</h1>
		<div id="bodyContent">
			<h3 id="siteSub" class='noprint'>From 2014.igem.org</h3>
			<div id="contentSub"><a href="/wiki/index.php?title=Special:Log&amp;page=Team%3ACAU+China%2Fjquery.plugin.min.js" title="Special:Log">View logs for this page</a></div>
						<!--
			<div id="jump-to-nav">Jump to:                        <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>-->
			<!-- start content -->
			<form action="/wiki/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Team:CAU_China/jquery.plugin.min.js" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;oldid=262867" title="Team:CAU China/jquery.plugin.min.js">03:42, 16 October 2014</a> <span class='history-user'><a href="/wiki/index.php?title=User:Roc&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Roc (page does not exist)">Roc</a>  <span class="mw-usertoollinks">(<a href="/wiki/index.php?title=User_talk:Roc&amp;action=edit&amp;redlink=1" class="new" title="User talk:Roc (page does not exist)">Talk</a> | <a href="/Special:Contributions/Roc" title="Special:Contributions/Roc">contribs</a>)</span></span> <span class="history-size">(13,870 bytes)</span> <span class="comment">(Created page with &quot;//jQuery Transit (function(d){function k(a){var b=[&quot;Moz&quot;,&quot;Webkit&quot;,&quot;O&quot;,&quot;ms&quot;],c=a.charAt(0).toUpperCase()+a.substr(1);if(a in i.style)return a;for(a=0;a&lt;b.length;++a){var d=b[a]+c;...&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://2014.igem.org/Team:CAU_China/jquery.plugin.min.js">http://2014.igem.org/Team:CAU_China/jquery.plugin.min.js</a>"</div>
...
<div class="visualClear"></div>
    <div id='footer-box' class='noprint'>
	   ...
	   <!-- Recentchanges is not handles well DEBUG -->
		     ...
		     <li id="t-whatlinkshere"><a href="/Special:WhatLinksHere/Team:CAU_China/jquery.plugin.min.js"
		      title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>

                         <li id="t-recentchangeslinked"><a href="/Special:RecentChangesLinked/Team:CAU_China/jquery.plugin.min.js"
                          title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>


	             <li id="feedlinks">
		             <span id="feed-atom">
		             <a href="/wiki/index.php?title=Team:CAU_China/jquery.plugin.min.js&amp;feed=atom&amp;action=history"
