...
<link title="Creative Commons" type="application/rdf+xml" href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;action=creativecommons" rel="meta" />
<link rel="copyright" href="http://creativecommons.org/licenses/by/3.0/" />
<link rel="alternate" type="application/atom+xml" title="&quot;Team:Arizona State/flexslider.min.js&quot; Atom feed" href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;feed=atom&amp;action=history" />
<link rel="alternate" type="application/atom+xml" title="2012.igem.org Atom feed" href="/wiki/index.php?title=Special:RecentChanges&amp;feed=atom" />		<title>Revision history of &quot;Team:Arizona State/flexslider.min.js&quot; - 2012.igem.org</title>
...
wgNamespaceNumber=0,
wgPageName="Team:Arizona_State/flexslider.min.js",
wgTitle="Team:Arizona State/flexslider.min.js",
wgAction="history",
wgArticleId=36453,
wgIsArticle=false,
wgUserName=null,
...
<body              class="mediawiki  ltr ns-0 ns-subject page-Team_Arizona_State_flexslider_min_js">
  <div id="globalWrapper">
	...
	<script type="text/javascript"> if (window.isMSIE55) fixalpha(); </script>
 	...
 	<div id="menubar" class='left-menu noprint'>
 	  <ul>
 	                   <li 
                class='selected' 	       ><a href="/Team:Arizona_State/flexslider.min.js">Page               </a></li>
               <li 
                class='new' 	       ><a href="/wiki/index.php?title=Talk:Team:Arizona_State/flexslider.min.js&amp;action=edit&amp;redlink=1">Discussion               </a></li>
               <li 
               	       ><a href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;action=edit">View source               </a></li>
               <li 
                class='selected' 	       ><a href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;action=history">History               </a></li>
	...
	<div class="right-menu noprint" id="menubar">
	    <ul>
                				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Team:Arizona_State/flexslider.min.js&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li> 	    </ul>
    ...
    <div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Revision history of &quot;Team:Arizona State/flexslider.min.js&quot;</h1>
		<div id="bodyContent">
			<h3 id="siteSub" class='noprint'>From 2012.igem.org</h3>
			<div id="contentSub"><a href="/wiki/index.php?title=Special:Log&amp;page=Team%3AArizona+State%2Fflexslider.min.js" title="Special:Log">View logs for this page</a></div>
						<!--
			<div id="jump-to-nav">Jump to:                        <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>-->
			<!-- start content -->
			<form action="/wiki/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Team:Arizona_State/flexslider.min.js" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;oldid=272271" title="Team:Arizona State/flexslider.min.js">05:46, 21 October 2012</a> <span class='history-user'><a href="/wiki/index.php?title=User:Eqin&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Eqin (page does not exist)">Eqin</a>  <span class="mw-usertoollinks">(<a href="/wiki/index.php?title=User_talk:Eqin&amp;action=edit&amp;redlink=1" class="new" title="User talk:Eqin (page does not exist)">Talk</a> | <a href="/Special:Contributions/Eqin" title="Special:Contributions/Eqin">contribs</a>)</span></span> <span class="history-size">(16,662 bytes)</span> <span class="comment">(Created page with &quot;<span class="autocomment">- <a href="/Team:Arizona_State/flexslider.min.js#.2A_jQuery_FlexSlider_v2.1_.2A_Copyright_2012_WooThemes_.2A_Contributing_Author:_Tyler_Smith" title="Team:Arizona State/flexslider.min.js">→</a>* jQuery FlexSlider v2.1  * Copyright 2012 WooThemes  * Contributing Author: Tyler Smith: </span> ;(function(d){d.flexslider=function(i,k){var a=d(i),c=d.extend({},d.flexslider.de...&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://2012.igem.org/Team:Arizona_State/flexslider.min.js">http://2012.igem.org/Team:Arizona_State/flexslider.min.js</a>"</div>
...
<div class="visualClear"></div>
    <div id='footer-box' class='noprint'>
	   ...
	   <!-- Recentchanges is not handles well DEBUG -->
		     ...
		     <li id="t-whatlinkshere"><a href="/Special:WhatLinksHere/Team:Arizona_State/flexslider.min.js"
		      title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>

                         <li id="t-recentchangeslinked"><a href="/Special:RecentChangesLinked/Team:Arizona_State/flexslider.min.js"
                          title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>


	             <li id="feedlinks">
		             <span id="feed-atom">
		             <a href="/wiki/index.php?title=Team:Arizona_State/flexslider.min.js&amp;feed=atom&amp;action=history"
