...
<link title="Creative Commons" type="application/rdf+xml" href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;action=creativecommons" rel="meta" />
<link rel="copyright" href="http://creativecommons.org/licenses/by/3.0/" />
<link rel="alternate" type="application/atom+xml" title="&quot;Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&quot; Atom feed" href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;feed=atom&amp;action=history" />
<link rel="alternate" type="application/atom+xml" title="2012.igem.org Atom feed" href="/wiki/index.php?title=Special:RecentChanges&amp;feed=atom" />		<title>Revision history of &quot;Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&quot; - 2012.igem.org</title>
...
wgNamespaceNumber=0,
wgPageName="Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js",
wgTitle="Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js",
wgAction="history",
wgArticleId=23759,
wgIsArticle=false,
wgUserName=null,
...
<body              class="mediawiki  ltr ns-0 ns-subject page-Team_Amsterdam_scripts_mathscribe_jqmath-etc-0_2_0_min_js">
  <div id="globalWrapper">
	...
	<script type="text/javascript"> if (window.isMSIE55) fixalpha(); </script>
 	...
 	<div id="menubar" class='left-menu noprint'>
 	  <ul>
 	                   <li 
                class='selected' 	       ><a href="/Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js">Page               </a></li>
               <li 
                class='new' 	       ><a href="/wiki/index.php?title=Talk:Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;action=edit&amp;redlink=1">Discussion               </a></li>
               <li 
               	       ><a href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;action=edit">View source               </a></li>
               <li 
                class='selected' 	       ><a href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;action=history">History               </a></li>
	...
	<div class="right-menu noprint" id="menubar">
	    <ul>
                				<li id="pt-login"><a href="/wiki/index.php?title=Special:UserLogin&amp;returnto=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li> 	    </ul>
    ...
    <div id="content">
		<a name="top" id="top"></a>
				<h1 class="firstHeading">Revision history of &quot;Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&quot;</h1>
		<div id="bodyContent">
			<h3 id="siteSub" class='noprint'>From 2012.igem.org</h3>
			<div id="contentSub"><a href="/wiki/index.php?title=Special:Log&amp;page=Team%3AAmsterdam%2Fscripts%2Fmathscribe%2Fjqmath-etc-0.2.0.min.js" title="Special:Log">View logs for this page</a></div>
						<!--
			<div id="jump-to-nav">Jump to:                        <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>-->
			<!-- start content -->
			<form action="/wiki/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;oldid=176140" title="Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js">17:07, 25 September 2012</a> <span class='history-user'><a href="/wiki/index.php?title=User:ErnstBank&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:ErnstBank (page does not exist)">ErnstBank</a>  <span class="mw-usertoollinks">(<a href="/wiki/index.php?title=User_talk:ErnstBank&amp;action=edit&amp;redlink=1" class="new" title="User talk:ErnstBank (page does not exist)">Talk</a> | <a href="/Special:Contributions/ErnstBank" title="Special:Contributions/ErnstBank">contribs</a>)</span></span> <span class="history-size">(37,600 bytes)</span> <span class="comment">(Created page with &quot;var jsCurry=function(){var sliceMF=Array.prototype.slice;if(!Function.prototype.bind)Function.prototype.bind=function(thisArg){var f=this,args0=sliceMF.call(arguments,1);return f...&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://2012.igem.org/Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js">http://2012.igem.org/Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js</a>"</div>
...
<div class="visualClear"></div>
    <div id='footer-box' class='noprint'>
	   ...
	   <!-- Recentchanges is not handles well DEBUG -->
		     ...
		     <li id="t-whatlinkshere"><a href="/Special:WhatLinksHere/Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js"
		      title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>

                         <li id="t-recentchangeslinked"><a href="/Special:RecentChangesLinked/Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js"
                          title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>


	             <li id="feedlinks">
		             <span id="feed-atom">
		             <a href="/wiki/index.php?title=Team:Amsterdam/scripts/mathscribe/jqmath-etc-0.2.0.min.js&amp;feed=atom&amp;action=history"
